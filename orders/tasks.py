...
@celery_app.task
def send_order_email(email_host_user: str, user_email: str, code: str, store_address: str, 
                     books: list[dict], total: int):
    html_message = render_to_string('orders/order_email.html', 
                                    {'title': "Вы успешно оформили заказ", 'store_address': store_address, 'code': code,
