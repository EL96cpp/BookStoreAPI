...
urlpatterns = [
    ...
    path('api/v1/profile/reviews', CustomerReviewsListView.as_view(), name="customer-reviews"),
    path('api/v1/profile/review/<int:pk>', CustomerReviewView.as_view(), name="customer-review"),
